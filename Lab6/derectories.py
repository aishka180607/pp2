...
def listOfAllFiles():
    ...
    for i in os.listdir(r"C:\Users\Аиша\Desktop\code\python"):
        if os.path.isdir(os.path.join(r"C:\Users\Аскар\Desktop\code\python", i)):
            print(i)
    print("\nAll files in this path: ")
    for i in os.listdir(r"C:\Users\Аиша\Desktop\code\python"):
        if os.path.isfile(os.path.join(r"C:\Users\Аскар\Desktop\code\python", i)):
            print(i)
...
def testForExistenceReadabilityWritabilityExecutability():
    path = r"C:\Users\Аиша\Desktop\code\python\Lab6"
...
def findingFilenameAndDirectory():
    path = r"C:\Users\Аиша\Desktop\code\python\Lab6\builtin.py"
...
def countingLines():
    path = r"C:\Users\Аиша\Desktop\code\python\Lab6\text.txt"
    f = open(path, "r")
    count = 0
    for i in f:
        if(i != "\n"):
...
def listToFile():
    path = r"C:\Users\Аиша\Desktop\code\python\Lab6\text.txt"
    my_list = [1, "Aиша", "Lenovo laptops are the best!", 4, "I hate stairs"]
...
def copyPaste():
    path = r"C:\Users\Аиша\Desktop\code\python\Lab6\text.txt"
    pathOfSecondfile = r"C:\Users\Аиша\Desktop\code\python\Lab6\text1.txt"
...
def delitingFileInSpecificPath():
    path = r"C:\Users\Аиша\Desktop\code\python\Lab6\text2.txt"
    if(os.access(path, os.F_OK)):
